"""MoleculeEntry: graph, thermochemistry, and fragment data for a single
species. Adapted from the framework of Barter et al. with this project's
modifications."""
...
from chemistry_lib.constants import ROOM_TEMP, metals
...
class MoleculeEntry:
    ...
    def from_dataset_entry(
        ...
        """
        Initialize a MoleculeEntry from a document in a LIBE-style dataset
        (Lithium-Ion Battery Electrolyte, or a Na-analog).

        Args:
            doc: Dictionary representing one species entry.
